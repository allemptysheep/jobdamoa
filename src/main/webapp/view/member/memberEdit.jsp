...
<% 
	...
	MemberDTO memberDTO =  memberDAO.getMemberDTO(mEmail);
%>
<script>
	function submitAgo() {
		var email = $('#email').val();
	...
	<div class="body-main">
		<div class="signup-main">
			...
			<div class="signup-box">
				<form action="/MemberController" method="post" onsubmit="return submitAgo()">
					<div class="signup-data-box">
					
						<div class="signup-email-box">
							<input class="form-control" type="text" name="member_email" id="email" value="<%=memberDTO.getEmail()%>" placeholder='<fmt:message key="MemberInfo.Email"/>' readonly="readonly"/>
						</div>
