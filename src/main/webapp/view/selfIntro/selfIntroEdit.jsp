...
<form action="/selfIntroServ" method="post" >
		<input name="selfIntroIdx" value="${selfIntroIdx}" readonly="readonly" hidden>
					...
					<div class="row">	
						<div class="col-4">
							<h4>자기소개서 이름</h4>
							<input name="sname" type="text" class="form-control form-control-sm" value="${selfintroData.sname}">
						</div>
					</div>
			 ...
			 <tr>
				...
				<div class="row">
					<div class="col-12">
						<textarea name="squestion" class="form-control" rows="3" cols="25">${selfintroData.squestion1}</textarea>
					</div>
					</div>
				</td>
			</tr>
			...
			<h5>■ 본인이 지원하는 직무에 있어 다른 지원자와는 차별화된 역략 및 그와 관련된 경험 혹은 경력을 기술하여 주십시오.</h5>
			 ...
			 <tr>
				...
				<div class="row">
					<div class="col-12">
						<textarea name="squestion2" class="form-control" rows="3" cols="25">${selfintroData.squestion2}</textarea>
					</div>
					</div>
				</td>
			</tr>
			...
			<h5>■ 기존과 다른 새로운 변화를 시도했던 경험과 그를 통해 배운 점이 무엇인지 기술하여 주십시오.</h5>
			 ...
			 <tr>
				...
				<div class="row">
					<div class="col-12">
						<textarea name="squestion3" class="form-control" rows="3" cols="25">${selfintroData.squestion3}</textarea>
					</div>
					</div>
				</td>
			</tr>
