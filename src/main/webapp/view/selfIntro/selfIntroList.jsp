...
<fmt:bundle basename="resource.language">
	...
	<%
		...
		List<Object> selfintroList = selfIntroDAO.selectSelfIntroList(mEmail);
		
		//System.out.println(selfintroList);
		pageContext.setAttribute("selfintroList", selfintroList);			// [{},{},{},{}]
		// resume {}
		//if()
	%>
	<script>
		function test(idx) {
			var link = '/view/selfIntro/selfIntroEdit.jsp?selfIntroIdx='+idx;			 
			location.href=link;
		}	
	</script>
	<div class="container main">
			<table border="0" width="100%">
				<tr>
					<td align="right">
						<button class="btn" onclick="location.href='/view/selfIntro/selfIntroWrite.jsp'">Add</button>
					</td>
				</tr>
			</table>
		<div class="row">
			...
			<table border="0" width="100%" align="center" class="table table-borderless">
				<tr align="center">
						<td width="25%">자기소개서 번호</td>
						<td width="37.8%">자기소개서 이름</td>
				...
				<c:forEach items="${selfintroList}" var="selfintro" varStatus="selfintroStatus">		
				<form action="/selfIntroServ" method="post">
					<table border="1" width="85%" align="center" class="table table-bordered">
						<input type="hidden" name="selfIntroIdx" value="${selfintro.selfIntroIdx}" readonly>
						<tr>
							<td width="25%">
								<div class="text-center">${selfintro.selfIntroIdx}</div>
							</td>
							<td width="37.8%">
								<div class="text-center">${selfintro.selfIntroName}</div>
							</td>
							<td width="22.1%">
								<div class="text-center">${selfintro.mEmail}</div>
							</td>
							<td align="center">
								<button type="button" class="btn" onclick="test(${selfintro.selfIntroIdx})">Edit</button>
							</td>
							<td align="center">
								<button class="btn" type="submit" name="operator" value="delete">Delete</button>
							</td>
						</tr>
					</table>
				</form>	
