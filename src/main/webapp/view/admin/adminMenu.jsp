	...
	<fmt:bundle basename="resource.language">
			<div class="d-flex flex-column flex-shrink-0 p-3 text-white bg-dark" style="width: 280px;">
			    <ul class="nav nav-pills flex-column mb-auto">
			      <li class="nav-item">
			        <a href="/view/admin/adminPage.jsp" class="nav-link active" aria-current="page">
			      ...
			      <li>
			        <a href="/view/admin/regionSetting.jsp" class="nav-link text-white">
			      ...
			      <li>
			        <a href="/view/admin/jobSetting.jsp" class="nav-link text-white">
			      ...
			      <li>
			        <a href="/view/admin/log.jsp" class="nav-link text-white">
